...
//==================================================================================================================================//
        ...
        SetupRoleOptions(300, TabGroup.ImpostorRoles, CustomRoles.ImpostorTOHEBR);
        SetupRoleOptions(400, TabGroup.ImpostorRoles, CustomRoles.ShapeshifterTOHEBR);
        ShapeshiftCD = FloatOptionItem.Create(402, "ShapeshiftCooldown", new(1f, 999f, 1f), 15f, TabGroup.ImpostorRoles, false)
            .SetParent(CustomRoleSpawnChances[CustomRoles.ShapeshifterTOHEBR])
            .SetValueFormat(OptionFormat.Seconds);
...
//==================================================================================================================================//
        ...
        SetupRoleOptions(5050, TabGroup.CrewmateRoles, CustomRoles.CrewmateTOHEBR);
        SetupRoleOptions(5000, TabGroup.CrewmateRoles, CustomRoles.EngineerTOHEBR);
        SetupRoleOptions(5100, TabGroup.CrewmateRoles, CustomRoles.ScientistTOHEBR);
        ScientistCD = FloatOptionItem.Create(5110, "VitalsCooldown", new(1f, 250f, 1f), 3f, TabGroup.CrewmateRoles, false)
            .SetParent(CustomRoleSpawnChances[CustomRoles.ScientistTOHEBR])
            .SetValueFormat(OptionFormat.Seconds);
