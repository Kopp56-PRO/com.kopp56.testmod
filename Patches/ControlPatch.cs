...
{
    private static readonly (int, int)[] resolutions = { (480, 270), (640, 360), (800, 450), (1280, 720), (1600, 900), (1920, 1080), (2560, 1440), (3840, 2160) };
    ...
    public static void Postfix(ControllerManager __instance)
    {
        ...
        if (GetKeysDown(KeyCode.Delete, KeyCode.LeftControl))
        {
            ...
            Logger.SendInGame(Translator.GetString("RestTOHEBRSetting"));
            ...
            {
                MessageWriter writer = AmongUsClient.Instance.StartRpcImmediately(PlayerControl.LocalPlayer.NetId, (byte)CustomRPC.RestTOHEBRSetting, SendOption.Reliable, -1);
