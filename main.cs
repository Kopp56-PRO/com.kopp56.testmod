...
[assembly: AssemblyFileVersion(TOHEBR.Main.PluginVersion)]
[assembly: AssemblyInformationalVersion(TOHEBR.Main.PluginVersion)]
[assembly: AssemblyVersion(TOHEBR.Main.PluginVersion)]
namespace TOHEBR;

[BepInPlugin(PluginGuid, "TOHEBR", PluginVersion)]
[BepInIncompatibility("jp.ykundesu.supernewroles")]
[BepInProcess("Among Us.exe")]
public class Main : BasePlugin
{
    // == プログラム設定 / Program Config ==
    public static readonly string ModName = "TOHE Brasil";
    public static readonly string ModColor = "#025dfa";
    public static readonly bool AllowPublicRoom = true;
    public static readonly string ForkId = "TOHE";
    public const string OriginalForkId = "Town Of Host Original";
    public static HashAuth DebugKeyAuth { get; private set; }
    public const string DebugKeyHash = "c0fd562955ba56af3ae20d7ec9e64c664f0facecef4b3e366e109306adeae29d";
    public const string DebugKeySalt = "59687b";
    public static ConfigEntry<string> DebugKeyInput { get; private set; }
    public static readonly string MainMenuText = " ";
    public const string PluginGuid = "com.Kopp56.TOHE-BY-KOPP56";
    public const string PluginVersion = "0.1.6";
    public const string PluginDisplayVersion = "0.1.6";
    ...
    public override void Load()
    {
        ...
        //Client Options
        HideName = Config.Bind("Client Options", "Hide Game Code Name", "TOHEBR");
        ...
        Logger = BepInEx.Logging.Logger.CreateLogSource("TOHEBR");
        TOHEBR.Logger.Enable();
        TOHEBR.Logger.Disable("NotifyRoles");
        TOHEBR.Logger.Disable("SwitchSystem");
        TOHEBR.Logger.Disable("ModNews");
        if (!DebugModeManager.AmDebugger)
        {
            TOHEBR.Logger.Disable("2018k");
            TOHEBR.Logger.Disable("Github");
            TOHEBR.Logger.Disable("CustomRpcSender");
            //TOHEBR.Logger.Disable("ReceiveRPC");
            TOHEBR.Logger.Disable("SendRPC");
            TOHEBR.Logger.Disable("SetRole");
            TOHEBR.Logger.Disable("Info.Role");
            TOHEBR.Logger.Disable("TaskState.Init");
            //TOHEBR.Logger.Disable("Vote");
            TOHEBR.Logger.Disable("RpcSetNamePrivate");
            //TOHEBR.Logger.Disable("SendChat");
            TOHEBR.Logger.Disable("SetName");
            //TOHEBR.Logger.Disable("AssignRoles");
            //TOHEBR.Logger.Disable("RepairSystem");
            //TOHEBR.Logger.Disable("MurderPlayer");
            //TOHEBR.Logger.Disable("CheckMurder");
            TOHEBR.Logger.Disable("PlayerControl.RpcSetRole");
            TOHEBR.Logger.Disable("SyncCustomSettings");
        }
        //TOHEBR.Logger.isDetail = true;
        ...
        try
        {
            roleColors = new Dictionary<CustomRoles, string>()
            {
                ...
                // Vanilla Remakes
                {CustomRoles.CrewmateTOHEBR, "#8cffff"},
                {CustomRoles.EngineerTOHEBR, "#FF6A00"},
                {CustomRoles.ScientistTOHEBR, "#8ee98e"},
                {CustomRoles.GuardianAngelTOHEBR, "#77e6d1"},
                //特殊クルー役職
     ...
     //           {CustomRoles.Reflective, "#FFD700"},
        ...
        {
            TOHEBR.Logger.Error("错误：字典出现重复项", "LoadDictionary");
            TOHEBR.Logger.Exception(ex, "LoadDictionary");
        ...
        TOHEBR.Logger.Info($"{Application.version}", "AmongUs Version");

        var handler = TOHEBR.Logger.Handler("GitVersion");
        ...
        TOHEBR.Logger.Msg("========= TOHEBR loaded! =========", "Plugin Load");
    }
}
