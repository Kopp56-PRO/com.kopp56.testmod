...
using TOHEBR.Modules;
using TOHEBR.Roles.Crewmate;
using UnityEngine;
using static TOHEBR.Translator;
using TOHEBR.Roles.Impostor;
...
internal class ChatCommands
{
    ...
    {
        var friendCodesFilePath = @"./TOHEBR-DATA/Moderators.txt";
                ...
                case "/changesetting":
                    ...
                    switch (subArgs)
                    {
                        ...
                        case "alcançe de ataque":
                            ...
                            break;
                        case "atualizar barra de tarefas":
                            subArgs = args.Length < 3 ? "" : args[2];
                            switch (subArgs)
                            {
                                case "sempre":
                        ...
                        case "mapa do impostor no esconderijo final":
                            ...
                            break;
                        case "avisos no esconderijo final":
                            subArgs = args.Length < 3 ? "" : args[2];
                            switch (subArgs)
                            {
                                case "ligado":
