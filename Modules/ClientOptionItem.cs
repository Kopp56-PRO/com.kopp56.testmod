...
public class ClientOptionItem
{
        ...
        Action additionalOnClickAction = null)
    {
        try
        {
            ...
            if (CustomBackground == null)
            {
                ...
                modOptionsButton.name = "TOHEBROptions";
                modOptionsButton.Text.text = Translator.GetString("TOHEBROptions");
                modOptionsButton.Background.color = new Color32(4, 96, 189, byte.MaxValue);
    ...
    public void UpdateToggle()
    {
        ...
        var color = Config.Value ? new Color32(4, 96, 189, byte.MaxValue) : new Color32(6, 32, 59, byte.MaxValue);
