...
using System.Linq;
using TOHEBR.Roles.Crewmate;
using TOHEBR.Roles.Neutral;
...
internal static class CustomRolesHelper
{
    public static CustomRoles GetVNRole(this CustomRoles role)
    {
        ...
        //        CustomRoles.Sorcerer => CustomRoles.Impostor,
                ...
                CustomRoles.ShapeshifterTOHEBR => CustomRoles.Shapeshifter,
                CustomRoles.Chronomancer => CustomRoles.Impostor,
                CustomRoles.ImpostorTOHEBR => CustomRoles.Impostor,
         ...
         //       CustomRoles.Mare => CustomRoles.Impostor,
                ...
                CustomRoles.ScientistTOHEBR => CustomRoles.Scientist,
                ...
                CustomRoles.EngineerTOHEBR => CustomRoles.Engineer,
                CustomRoles.TimeMaster => CustomRoles.Engineer,
                CustomRoles.CrewmateTOHEBR => CustomRoles.Crewmate,
           ...
           //     CustomRoles.Minimalism => CustomRoles.Impostor,
                ...
                CustomRoles.GuardianAngelTOHEBR => CustomRoles.GuardianAngel,
        ...
        public static CustomRoles GetErasedRole(this CustomRoles role)
    {
        return role.IsVanilla()
            ...
            : role switch
            {
                CustomRoles.Tracker => CustomRoles.CrewmateTOHEBR,
                CustomRoles.Mayor => Options.MayorHasPortableButton.GetBool() ? CustomRoles.EngineerTOHEBR : CustomRoles.CrewmateTOHEBR,
                CustomRoles.Monitor => Monitor.CanVent.GetBool() ? CustomRoles.EngineerTOHEBR : CustomRoles.CrewmateTOHEBR,
                CustomRoles.Observer => CustomRoles.CrewmateTOHEBR,
                CustomRoles.DovesOfNeace => CustomRoles.EngineerTOHEBR,
                CustomRoles.Judge => CustomRoles.CrewmateTOHEBR,
                CustomRoles.Cleanser => CustomRoles.CrewmateTOHEBR,
                CustomRoles.Mortician => CustomRoles.CrewmateTOHEBR,
                CustomRoles.Mediumshiper => CustomRoles.CrewmateTOHEBR,
             //   CustomRoles.Glitch => CustomRoles.CrewmateTOHEBR,
                CustomRoles.Bodyguard => CustomRoles.CrewmateTOHEBR,
                CustomRoles.ParityCop => CustomRoles.CrewmateTOHEBR,
                CustomRoles.Lookout => CustomRoles.CrewmateTOHEBR,
                CustomRoles.Grenadier => CustomRoles.EngineerTOHEBR,
                CustomRoles.Transporter => CustomRoles.CrewmateTOHEBR,
                CustomRoles.Veteran => CustomRoles.CrewmateTOHEBR,
                CustomRoles.GuardianAngelTOHEBR => CustomRoles.GuardianAngel,
                CustomRoles.Detective => CustomRoles.CrewmateTOHEBR,
                CustomRoles.NiceGuesser => CustomRoles.CrewmateTOHEBR,
                CustomRoles.Luckey => CustomRoles.CrewmateTOHEBR,
                CustomRoles.CyberStar => CustomRoles.CrewmateTOHEBR,
                CustomRoles.Psychic => CustomRoles.CrewmateTOHEBR,
                CustomRoles.Needy => CustomRoles.CrewmateTOHEBR,
                CustomRoles.SuperStar => CustomRoles.CrewmateTOHEBR,
                CustomRoles.Paranoia => CustomRoles.EngineerTOHEBR,
                CustomRoles.EngineerTOHEBR => CustomRoles.EngineerTOHEBR,
                CustomRoles.TimeMaster => CustomRoles.EngineerTOHEBR,
                CustomRoles.Reverie => CustomRoles.CrewmateTOHEBR,
                CustomRoles.CrewmateTOHEBR => CustomRoles.CrewmateTOHEBR,
                CustomRoles.Doctor => CustomRoles.ScientistTOHEBR,
                CustomRoles.ScientistTOHEBR => CustomRoles.ScientistTOHEBR,
                CustomRoles.Tracefinder => CustomRoles.ScientistTOHEBR,
                CustomRoles.SpeedBooster => CustomRoles.CrewmateTOHEBR,
                CustomRoles.Dictator => CustomRoles.CrewmateTOHEBR,
                CustomRoles.Snitch => CustomRoles.CrewmateTOHEBR,
                CustomRoles.Marshall => CustomRoles.CrewmateTOHEBR,
                CustomRoles.SabotageMaster => CustomRoles.EngineerTOHEBR,
                CustomRoles.Retributionist => CustomRoles.Crewmate,
                CustomRoles.Monarch => CustomRoles.CrewmateTOHEBR,
                CustomRoles.Deputy => CustomRoles.CrewmateTOHEBR,
                CustomRoles.Guardian => CustomRoles.CrewmateTOHEBR,
                CustomRoles.Addict => CustomRoles.EngineerTOHEBR,
                CustomRoles.Oracle => CustomRoles.EngineerTOHEBR,
                CustomRoles.Chameleon => CustomRoles.EngineerTOHEBR,
                _ => role.IsImpostor() ? CustomRoles.ImpostorTOHEBR : CustomRoles.CrewmateTOHEBR,
            };
    }
 ...
 //           CustomRoles.PotionMaster or
    ...
    public static bool IsImpostor(this CustomRoles role) // IsImp
    {
        return role is
            ...
            CustomRoles.ShapeshifterTOHEBR or
            CustomRoles.ImpostorTOHEBR or
        ...
        switch (role)
        {
            case CustomRoles.Autopsy:
                if (pc.Is(CustomRoles.Doctor)
                    ...
                    || pc.Is(CustomRoles.ScientistTOHEBR)
            ...
            case CustomRoles.Bait:
                if (pc.Is(CustomRoles.Trapper)
                    ...
                    || pc.Is(CustomRoles.GuardianAngelTOHEBR))
                    return false;
            ...
            case CustomRoles.Brakar:
                if (pc.Is(CustomRoles.Dictator)
                    || pc.Is(CustomRoles.GuardianAngelTOHEBR)) return false;
            ...
            case CustomRoles.Loyal:
                if (pc.Is(CustomRoles.Madmate) || pc.Is(CustomRoles.GuardianAngelTOHEBR))
                    return false;
                if (!pc.GetCustomRole().IsImpostor() && !pc.GetCustomRole().IsCrewmate())
                    return false;
            ...
            case CustomRoles.Fool:
                if (pc.Is(CustomRoles.SabotageMaster) || pc.Is(CustomRoles.GuardianAngelTOHEBR))
                    return false;
