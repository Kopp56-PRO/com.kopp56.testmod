...
public static class OptionsMenuBehaviourStartPatch
{
    ...
    public static void Postfix(OptionsMenuBehaviour __instance)
    {
        ...
        if (Main.ResetOptions || !DebugModeManager.AmDebugger)
        {
            ...
            Main.InfiniteVision.Value = false;
        }
        ...
        if (SwitchVanilla == null || SwitchVanilla.ToggleButton == null)
        {
            ...
            static void SwitchVanillaButtonToggle()
            {
             ...
             if ((VersionCheat == null || VersionCheat.ToggleButton == null) && DebugModeManager.AmDebugger)
                ...
                if ((InfiniteVision == null || InfiniteVision.ToggleButton == null) && DebugModeManager.AmDebugger)
                {
                GodMode = ClientOptionItem.Create("InfiniteVision", Main.InfiniteVision, __instance);
                }
    }
}
