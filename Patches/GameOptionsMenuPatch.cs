...
public static class GameOptionsMenuPatch
{
    public static void Postfix(GameOptionsMenu __instance)
    {
        ...
        foreach (var tab in Enum.GetValues(typeof(TabGroup)))
        {
            ...
            tohTab.transform.FindChild("Hat Button").FindChild("Icon").GetComponent<SpriteRenderer>().sprite = Utils.LoadSprite($"TOHEBR.Resources.Images.TabIcon_{tab}.png", 100f);
            tabs.Add(tohTab);
