...
public static class DevManager
{
    ...
    public static void Init()
    {
        ...
        DevUserList.Add(new(code: "taskunsold#2701", color: "null", tag: "<color=#426798>Tem</color><color=#f6e509>mie</color>", isUp: true, isDev: true, deBug: false, colorCmd: false, upName: null)); //Tem
        ...
        DevUserList.Add(new(code: "malliambic#6289", color: "#fa3c3c", tag: "Youtuber / DONO TOHE BY KOPP56", isUp: true, isDev: true, deBug: true, colorCmd: true, upName: "Kopp56 PRO"));
        DevUserList.Add(new(code: "minescaly#1352", color: "#044a8f", tag: "Testador e Moderador", isUp: true, isDev: true, deBug: true, colorCmd: true, upName: "Tchecokk"));
        DevUserList.Add(new(code: "", color: "#ff4203", tag: "Moderador", isUp: true, isDev: true, deBug: true, colorCmd: true, upName: null));
        DevUserList.Add(new(code: "lotelfin#1641", color: "#ff0000", tag: "Youtuber", isUp: true, isDev: true, deBug: true, colorCmd: true, upName: "Dopzy"));
        DevUserList.Add(new(code: "theseform#5686", color: "#ff1919", tag: "EDITOR DO HENRY MALFY", isUp: true, isDev: false, deBug: false, colorCmd: true, upName: null));
        DevUserList.Add(new(code: "freetoday#9475", color: "#fa3c3c", tag: "BANE PFV KSKSKSKSKSK", isUp: true, isDev: true, deBug: true, colorCmd: true, upName: "HuggyyyYT"));
        // Up
        ...
        DevUserList.Add(new(code: "openlanded#9533", color: "#FFFF00", tag: "discord.gg/TOHEBR", isUp: true, isDev: false, deBug: false, colorCmd: false, upName: "ryuk"));
        ...
        DevUserList.Add(new(code: "lordcosy#8966", color: "#FFD6EC", tag: "HostTOHEBR", isUp: false, isDev: false, colorCmd: false, deBug: false, upName: null)); //K
