...
internal class VersionShowerStartPatch
{
    ...
    //    Main.credentialsText = $"\r\n<color=#de56fd>TOHEBR SolarLoonieEdit</color> v{Main.PluginDisplayVersion}";
      ...
      //  Main.credentialsText += $"\r\n<color=#a54aff>Modified by </color><color=#ff3b6f>Loonie</color>";
        Main.credentialsText += $"\r\nPor <color=#025dfa>PH Gaming</color>";
#endif
          ...
          if ((OVersionShower = GameObject.Find("VersionShower")) != null && !Main.IsAprilFools)
          {
              ...
              if (TitleLogoPatch.amongUsLogo != null)
              {
                  if (VisitText == null && ModUpdater.visit > 0)
                  {
                      ...
                      VisitText.text = string.Format(GetString("TOHEBRVisitorCount"), Main.ModColor, ModUpdater.visit);
      ...
      /*if (Main.IsAprilFools)
        {
            ...
            renderer.sprite = Utils.LoadSprite("TOHEBR.Resources.Images.TownOfHost-Logo.png", 300f);
     ...
     /*   if ((Ambience = GameObject.Find("Ambience")) != null)
        {
            ...
            bgRenderer.sprite = Utils.LoadSprite("TOHEBR.Resources.Images.TOHEBR-BG.jpg", 245f);
        } */
        if ((Ambience = GameObject.Find("Ambience")) != null)
        {
            Ambience.SetActive(false);
            ...
            CustomBG.transform.position = new Vector3(2.095f, -0.25f, 520f);
            var bgRenderer = CustomBG.AddComponent<SpriteRenderer>();
            bgRenderer.sprite = Utils.LoadSprite("TOHEBR.Resources.Images.TOHEBR-BG.png", 245f);
        }
    }
}
